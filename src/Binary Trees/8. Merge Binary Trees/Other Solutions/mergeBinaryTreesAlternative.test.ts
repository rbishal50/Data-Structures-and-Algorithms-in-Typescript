import {
  BinaryTree,
  mergeBinaryTreesAlternative,
} from "./mergeBinaryTreesAlternative";

describe("mergeBinaryTreesAlternative", () => {
  it("should merge two balanced trees with overlapping nodes", () => {
    ...
    */
    ...
    const mergedTree = mergeBinaryTreesAlternative(tree1, tree2);
